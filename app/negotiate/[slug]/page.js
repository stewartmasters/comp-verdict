import {
  en, SALARY_ROLES, slug, buildNegPageProps, buildNegSlugMap,
...
export default async function NegotiatePage({ params }) {
  const { slug: slugParam } = await params
  const match = slugMap[slugParam]
  ...
  return (
    <>
      ...
      <NegotiatePageContent
        ...
        negHubPath={props.negHubPath}
        homePath={props.homePath}
        salaryPath={props.salaryPath}
        relatedRoles={props.relatedRoles}
        relatedCities={props.relatedCities}
        jsonLd={props.jsonLd}
